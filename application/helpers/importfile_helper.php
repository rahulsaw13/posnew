...
function generate_import_items_csv($stock_locations,$attributes)
{
	...
	$csv_headers .= '"Id","Barcode","Item Name","Category","Supplier ID","Cost Price","Unit Price","Tax 1 Name","Tax 1 Percent","Tax 2 Name","Tax 2 Percent","Reorder Level","Description","Allow Alt Description","Item has Serial Number","Image","HSN","Batch #"';
	...
	$csv_data = [
		...
		'2.50',
		'1',
		'"gulab khas mangos sweet in taste"',
		'"gulab khas"',
		'0',
		'""',
		'""',
