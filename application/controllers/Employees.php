...
class Employees extends Persons
{
	...
	*/
	public function save($employee_id = -1)
	{
		...
		$employees_advance_salary = $this->xss_clean(strtolower($this->input->post('employees_advance_salary')));
		$employees_advance_salary = (($employees_advance_salary)? $employees_advance_salary:0);
		$employees_daily_salary = $this->xss_clean(strtolower($this->input->post('employees_daily_salary')));
		$employees_daily_salary = (($employees_daily_salary)? $employees_daily_salary:0);
		$employees_monthly_salary = $this->xss_clean(strtolower($this->input->post('employees_monthly_salary')));
		$employees_monthly_salary = (($employees_monthly_salary)? $employees_monthly_salary:0);
		...
		if($this->Employee->save_employee($person_data, $employee_data, $grants_array, $employee_id) && $this->Employee->save_employee_salary($employees_advance_salary,$employees_daily_salary, $employees_monthly_salary, $employee_id))
