...
$route['attendances/index/([^/]+)'] = 'attendances/manage/$1';
$route['payments/index/([^/]+)'] = 'payments/manage/$1';
...
$route['bankdetails'] = 'bankdetails/index';
$route['referrals'] = 'referrals/index';
$route['detailed_referral_report/(:num)'] = 'detailed_referral_report/index/$1';
$route['items/(:num)'] = 'items/view_item/$1';
