<div class="col-xs-4 padding-20">
	<div class="form-group form-group-sm">
		<?php echo form_label($this->lang->line("attributes_definition_name"), "definition_name_label", array('class' => 'control-label')); ?>
		<?php echo form_dropdown('definition_name', $definition_names, -1, array('id' => 'definition_name', 'class' => 'form-control cursor-pointer custom-input-with-border')); ?>
	</div>
</div>
...
<div class="col-xs-4 padding-20">
	<div class="form-group form-group-sm">
		<?php echo form_label($definition_value['definition_name'], $definition_value['definition_name'], array('class' => 'control-label')); ?>
		<div class="input-group">
			<?php
				...
				if ($definition_value['definition_type'] == DATE)
				{
					...
					echo form_input(array(
						...
						'value' => to_date($value),
						'class' => 'form-control input-sm datetime bg-white custom-input-without-right-border',
				...
				else if ($definition_value['definition_type'] == DROPDOWN)
				{
					...
					echo form_dropdown("attribute_links[$definition_id]", $definition_value['values'], $selected_value, "class='form-control cursor-pointer custom-input-without-right-border' data-definition-id='$definition_id'");
				}
				else if ($definition_value['definition_type'] == TEXT)
				{
					...
					echo form_input("attribute_links[$definition_id]", $value, "class='form-control valid_chars custom-input-without-right-border' data-definition-id='$definition_id'");
				}
			...
			?>
			<span class="input-group-addon input-sm btn btn-default remove_attribute_btn theme-bg-color mix-input-icon-right-tag"><span class="glyphicon glyphicon-trash"></span></span>
		</div>
	</div>
</div>
