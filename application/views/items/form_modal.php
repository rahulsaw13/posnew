...
<?php echo form_open('items/save/'.$item_info->item_id, array('id'=>'item_form', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
	<fieldset id="item_basic_info">
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_item_number'), 'item_number', array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class='col-xs-8'>
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_name'), 'name', array('class'=>'required control-label col-xs-3 text-left')); ?>
			<div class='col-xs-8'>
				<?php echo form_input(array(
						'name'=>'name',
						'id'=>'name',
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_batch_number'), 'batch_number', array('class'=>'required control-label col-xs-3 text-left')); ?>
			<div class='col-xs-8'>
				<?php echo form_input(array(
						'name'=>'batch_number',
						'id'=>'batch_number',
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_category'), 'category', array('class'=>'required control-label col-xs-3 text-left')); ?>
			<div class='col-xs-8'>
				<div class="input-group">
		...
		<div id="attributes">
			<script type="text/javascript">
				$('#attributes').load('<?php echo site_url("items/attributes_modal/$item_info->item_id");?>');
			</script>
		</div>

		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_stock_type'), 'stock_type', !empty($basic_version) ? array('class'=>'required control-label col-xs-3 text-left') : array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class="col-xs-8">
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_type'), 'item_type', !empty($basic_version) ? array('class'=>'required control-label col-xs-3 text-left') : array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class="col-xs-8">
				<label class="radio-inline">
					<?php
						$radio_button = array(
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_supplier'), 'supplier', array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class='col-xs-8'>
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_cost_price'), 'cost_price', array('class'=>'required control-label col-xs-3 text-left')); ?>
			<div class="col-xs-4">
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_unit_price'), 'unit_price', array('class'=>'required control-label col-xs-3 text-left')); ?>
			<div class='col-xs-4'>
				<div class="input-group input-group-sm">
					<?php if (!currency_side()): ?>
						<span class="input-group-addon input-sm"><b><?php echo $this->config->item('currency_symbol'); ?></b></span>
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label('Items Wholesale Price', 'wholesale_price', array('class'=>'required control-label col-xs-3 text-left')); ?>
			<div class='col-xs-4'>
				<div class="input-group input-group-sm">
					<?php if (!currency_side()): ?>
						<span class="input-group-addon input-sm"><b><?php echo $this->config->item('currency_symbol'); ?></b></span>
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label('Items Commission Price', 'commission_percentage', array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class='col-xs-4'>
				<div class="input-group input-group-sm">
					<?php echo form_input(array(
						...
						'class' => 'form-control input-sm',
						'value' => to_decimals($item_info->commission_percentage), // Show the percentage value
						'onClick' => 'this.select();',
						'oninput' => 'updateCommissionPrice()', // Recalculate commission price when percentage is updated
					)); ?>
					<span class="input-group-addon input-sm"><b>%</b></span>
				</div>
			</div>
			<div class="col-xs-4 d-flex justify-content-center align-items-center">
			<span id="commission_price_display" style="font-weight: bold; font-style: italic;">
				<?php echo '('.to_currency($item_info->commission_price).')'; ?> <!-- Display initial commission price -->
			</span>
			</div>
		</div>

		<!-- Hidden input for commission price to submit in the form -->
		<?php echo form_hidden('commission_price', $item_info->commission_price); ?>
		...
		?>
			<div class="form-group form-group-sm mx-0">
				<?php echo form_label($this->lang->line('items_tax_1'), 'tax_percent_1', array('class'=>'control-label col-xs-3 text-left')); ?>
				<div class='col-xs-4'>
					<?php echo form_input(array(
							'name'=>'tax_names[]',
							'id'=>'tax_name_1',
			...
			<div class="form-group form-group-sm mx-0">
				<?php echo form_label($this->lang->line('items_tax_2'), 'tax_percent_2', array('class'=>'control-label col-xs-3 text-left')); ?>
				<div class='col-xs-4'>
					<?php echo form_input(array(
							'name'=>'tax_names[]',
							'id'=>'tax_name_2',
		...
		<?php if($use_destination_based_tax): ?>
			<div class="form-group form-group-sm mx-0">
				<?php echo form_label($this->lang->line('taxes_tax_category'), 'tax_category', array('class'=>'control-label col-xs-3 text-left')); ?>
				<div class='col-xs-8'>
					<div class="input-group input-group-sm">
						<?php echo form_input(array(
								'name'=>'tax_category',
		...
		<?php if($include_hsn): ?>
			<div class="form-group form-group-sm mx-0">
				<?php echo form_label($this->lang->line('items_hsn_code'), 'category', array('class'=>'control-label col-xs-3 text-left')); ?>
				<div class='col-xs-8'>
					<div class="input-group">
						<?php echo form_input(array(
								'name'=>'hsn_code',
		...
		?>
			<div class="form-group form-group-sm mx-0">
				<?php echo form_label($this->lang->line('items_quantity').' '.$location_detail['location_name'], 'quantity_' . $key, array('class'=>'required control-label col-xs-3 text-left')); ?>
				<div class='col-xs-4'>
					<?php echo form_input(array(
							'name'=>'quantity_' . $key,
							'id'=>'quantity_' . $key,
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_receiving_quantity'), 'receiving_quantity', array('class'=>'required control-label col-xs-3 text-left')); ?>
			<div class='col-xs-4'>
				<?php echo form_input(array(
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_reorder_level'), 'reorder_level', array('class'=>'required control-label col-xs-3 text-left')); ?>
			<div class='col-xs-4'>
				<?php echo form_input(array(
						'name'=>'reorder_level',
						'id'=>'reorder_level',
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_description'), 'description', array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class='col-xs-8'>
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_image'), 'items_image', array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class='col-xs-8'>
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_allow_alt_description'), 'allow_alt_description', array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class='col-xs-1'>
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_is_serialized'), 'is_serialized', array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class='col-xs-1'>
				<?php echo form_checkbox(array(
						'name'=>'is_serialized',
						'id'=>'is_serialized',
		...
		if($this->config->item('multi_pack_enabled') == '1')
		{
			?>
			<div class="form-group form-group-sm mx-0">
				<?php echo form_label($this->lang->line('items_qty_per_pack'), 'qty_per_pack', array('class'=>'control-label col-xs-3 text-left')); ?>
				<div class='col-xs-4'>
					<?php echo form_input(array(
							'name'=>'qty_per_pack',
							'id'=>'qty_per_pack',
			...
			<div class="form-group form-group-sm mx-0">
				<?php echo form_label($this->lang->line('items_pack_name'), 'name', array('class'=>'control-label col-xs-3 text-left')); ?>
				<div class='col-xs-8'>
					<?php echo form_input(array(
							'name'=>'pack_name',
							'id'=>'pack_name',
			...
			<div class="form-group  form-group-sm">
				<?php echo form_label($this->lang->line('items_low_sell_item'), 'low_sell_item_name', array('class'=>'control-label col-xs-3 text-left')); ?>
				<div class='col-xs-8'>
					<div class="input-group input-group-sm">
						<?php echo form_input(array(
		...
		<div class="form-group form-group-sm mx-0">
			<?php echo form_label($this->lang->line('items_is_deleted'), 'is_deleted', array('class'=>'control-label col-xs-3 text-left')); ?>
			<div class='col-xs-1'>
				<?php echo form_checkbox(array(
						'name'=>'is_deleted',
						'id'=>'is_deleted',
	...
	var init_validation = function() {
		$('#item_form').validate($.extend({
			...
			messages:
			{
				...
				wholesale_price:
				{
					required: "<?php echo $this->lang->line('items_wholesale_price_required'); ?>",
					number: "<?php echo $this->lang->line('items_wholesale_price_number'); ?>"
				},
				<?php
				foreach($stock_locations as $key=>$location_detail)
				{
...
function updateCommissionPrice() {
    // Get the commission percentage and cost price values
    ...
    // Calculate the commission price (if cost price and percentage are provided)
    var commissionPrice = (commissionPercentage / 100) * costPrice;

    // Display the commission price calculation next to the input field
    document.getElementById('commission_price_display').innerText = '(' + toCurrencyFormat(commissionPrice) + ')';

    // Update the hidden commission_price field with the calculated value
    document.getElementsByName('commission_price')[0].value = commissionPrice.toFixed(2); 
}

// Helper function to format numbers as currency
function toCurrencyFormat(amount) {
    var symbol = '<?php echo $this->config->item('currency_symbol'); ?>'; 
