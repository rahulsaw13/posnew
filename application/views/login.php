...
<head>
  <meta charset="utf-8">
	...
	<link href="<?php echo base_url('uploads/dukaandari_logo2-new.png'); ?>" rel="shortcut icon" type="image/x-icon">
  ...
  <main class="d-flex justify-content-around align-items-center flex-grow-1">
    <div class="container-login container-fluid d-flex flex-column flex-md-row bg-body shadow rounded m-3 p-4 p-md-0">
      ...
      <?php if ($this->Appconfig->get('company_logo')): ?>
        ...
        <?php elseif (!file_exists(FCPATH . 'public/uploads/dukaandari_logo2-new.png')): ?>
            <img class="logo w-100" src="<?php echo base_url('uploads/dukaandari_logo2-new.png'); ?>" alt="DukaandariLogo">
        <?php else: ?>
      ...
      <!-- <div class="box-logo">
        <img src="<?php echo base_url('uploads/login-theme.jpg'); ?>" alt="login-theme">
      </div> -->
    </div>
  </main>
