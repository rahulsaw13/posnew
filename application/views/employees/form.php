...
<div id="custom-toaster" class="toaster">Employee has been <?php echo $toaster_text; ?>.</div>
...
<?php echo form_open($controller_name . '/save/' . $person_info->person_id, array('id'=>'employee_form', 'class'=>'form-horizontal')); ?>
	<div class="new-form-design-background">
		<div class="form-header"><?php echo $text; ?> Employee</div>
		<div class="new-form-design-container">
			...
			<div class="col-xs-4 padding-20">
					<div class="form-group form-group-sm">	
						<?php echo form_label($this->lang->line('employees_advance_salary'), 'employees_advance_salary', array('class'=>'control-label')); ?>
						<div class="input-group w-full custom-form-group">
						 <span class="input-group-addon input-sm theme-bg-color mix-input-icon-width mix-input-icon-left-tag"><span class="rupee-symbol">&#8377;</span></span>
							<?php echo form_input(array(
									'name'=>'employees_advance_salary',
									'id'=>'employees_advance_salary',
									'placeholder' => $this->lang->line('employees_advance_salary'),
									'class'=>'form-control input-sm custom-input custom-input-width-with-error',
									'value'=>$salary_info->employee_advance_salary)
									);?>
						</div>
					</div>
				</div>
				<div class="col-xs-4 padding-20">
					<div class="form-group form-group-sm">	
						<?php echo form_label($this->lang->line('employees_monthly_salary'), 'employees_monthly_salary', array('class'=>'control-label')); ?>
						<div class="input-group w-full custom-form-group">
						 <span class="input-group-addon input-sm theme-bg-color mix-input-icon-width mix-input-icon-left-tag"><span class="rupee-symbol">&#8377;</span></span>
							<?php echo form_input(array(
									'name'=>'employees_monthly_salary',
									'id'=>'employees_monthly_salary',
									'placeholder' => $this->lang->line('employees_monthly_salary'),
									'class'=>'form-control input-sm custom-input custom-input-width-with-error',
									'value'=>$salary_info->employee_monthly_salary)
									);?>
						</div>
					</div>
				</div>
				<div class="col-xs-4 padding-20">
					<div class="form-group form-group-sm">	
						<?php echo form_label($this->lang->line('employees_daily_salary'), 'employees_daily_salary', array('class'=>'control-label')); ?>
						<div class="input-group w-full custom-form-group">
						 <span class="input-group-addon input-sm theme-bg-color mix-input-icon-width mix-input-icon-left-tag"><span class="rupee-symbol">&#8377;</span></span>
							<?php echo form_input(array(
									'name'=>'employees_daily_salary',
									'id'=>'employees_daily_salary',
									'placeholder' => $this->lang->line('employees_daily_salary'),
									'class'=>'form-control input-sm custom-input custom-input-width-with-error',
									'value'=>$salary_info->employee_daily_salary)
									);?>
						</div>
					</div>
				</div>
			...
			<hr class="mb-0 mt-10">
			<fieldset class="row m-0 p-0" id="employee_login_info">
				<div class="row mx-10">
					<div class="col-xs-4 padding-20">	
						<div class="form-group form-group-sm">	
				...
				<div class="row mx-10">
					<div class="col-xs-4 padding-20">
						<div class="form-group form-group-sm">
							<?php echo form_label($this->lang->line('employees_language'), 'language', array('class' => 'control-label')); ?>
							<div class="input-group w-full custom-form-group customized-error-input">
								<?php 
									...
									echo form_dropdown(
										...
										array('class' => 'form-control cursor-pointer custom-input-with-border')
										);
								?>
							</div>
						</div>
			...
			<div class="design-header mt-10">
				<span class="glyphicon glyphicon-cog"></span><span class="design-header-text"><?php echo $this->lang->line("employees_permission_info"); ?></span>
			</div>
			<hr class="mb-0 mt-10">
			<fieldset  class="row m-0" id="employee_permission_info">
				<div class="row mx-10 p-0">
					<p><?php echo $this->lang->line("employees_permission_desc"); ?></p>
	
					<ul id="permission_list" class="custom-ul">
						<?php
						...
						?>
							<li class="custom-li">	
								<div class="d-flex-row">
									<?php echo form_checkbox("grant_".$module->module_id, $module->module_id, $module->grant, "class='module m-0'"); ?>
									<span class="medium"><?php echo $this->lang->line('module_'.$module->module_id);?>:</span>
									<span class="small truncate-text"><?php echo $this->lang->line('module_'.$module->module_id.'_desc');?></span>
								</div>
								<div class="form-group form-group-sm ml-0">
									<?php echo form_dropdown("menu_group_".$module->module_id, array(
										...
										'class' => 'form-control cursor-pointer custom-input-with-border w-28'
									), $module->menu_group, "class='module form-control w-28 custom-input-with-border'"); ?>
								</div>
								<div class="inner-checkboxes-container">
									<?php
