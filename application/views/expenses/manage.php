...
<div id="title_bar" class="print_hide btn-toolbar">
	...
	<button class='btn btn-info btn-sm pull-right' onclick="window.location.href='<?php echo site_url($controller_name . '/view'); ?>'" title="<?php echo $this->lang->line($controller_name . '_new'); ?>">
