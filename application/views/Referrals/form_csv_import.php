...
<?php echo form_open_multipart('referals/do_csv_import/', array('id'=>'csv_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="item_basic_info">
		<div class="form-group form-group-sm">
			<div class="col-xs-12">
				<a href="<?php echo site_url('referals/csv'); ?>"><?php echo $this->lang->line('common_download_import_template'); ?></a>
			</div>
		</div>
	...
	$('#csv_form').validate($.extend({
		submitHandler: function(form) {
			$(form).ajaxSubmit({
				...
				{
					dialog_support.hide();
					table_support.handle_submit('<?php echo site_url('referals'); ?>', response);
				},
				dataType: 'json'
			});
		},
